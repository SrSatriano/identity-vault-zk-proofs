...
1. Envie descrição detalhada para o mantenedor via GitHub Security Advisories ou contato privado do repositório [identity-vault-zk-proofs](https://github.com/SrSatriano/identity-vault-zk-proofs).
