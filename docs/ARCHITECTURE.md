# Arquitetura — Cofre de identidade com provas zero-knowledge

> Versão do documento: **1.0.0** · Última revisão: **2026-03-26**

## 1. Visão geral

Circuitos Groth16 com verifier em contrato e CLI prove/verify.
...
|------------|------------------|
| Circuit | Circuit balance.circom |
| Contrato | Contrato verifier |
| CLI | CLI de prova |
| Testes | Testes Hardhat |
