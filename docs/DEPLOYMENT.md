# Guia de deploy — Cofre de identidade com provas zero-knowledge

> Versão **1.0.0** · Stack: **Circom, SnarkJS, Solidity, Hardhat**
...
3. Execute `npx hardhat test` ou smoke tests automatizados.
