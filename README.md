# Identity Vault with Zero-Knowledge Proofs
...
> **Prova de saldo/KYC sem revelar dados on-chain.**

Desenvolvido e mantido por [@SrSatriano](https://github.com/SrSatriano). Repositório: [identity-vault-zk-proofs](https://github.com/SrSatriano/identity-vault-zk-proofs).
...
- [x] Groth16 verifier contract
- [x] CLI prove/verify
- [x] Tempos de prova documentados
- [x] Deploy Sepolia script
