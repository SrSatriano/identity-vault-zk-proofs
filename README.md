...
# Cofre de identidade com provas zero-knowledge

<p>
  <a href="https://github.com/SrSatriano/identity-vault-zk-proofs"><img src="https://img.shields.io/badge/GitHub-identity-vault-zk-proofs-24292e?style=for-the-badge&logo=github&logoColor=white" alt="GitHub" /></a>
...
<p>
  ...
  <img src="https://img.shields.io/badge/Tier-3-8b5cf6?style=flat-square" alt="tier" />
...
<p><strong>Provar saldo ou KYC sem revelar dados sensíveis on-chain.</strong></p>
...
| | |
|---|---|
| **Problema** | On-chain transparency expõe PII e patrimônio. |
| **Solução** | Circuitos Groth16 com verifier em contrato e CLI prove/verify. |

## Para quem é

Protocolos DeFi com requisitos de compliance.

## Casos de uso

- Prova de saldo mínimo
- KYC seletivo

## Funcionalidades

- [x] Circuit balance.circom
- [x] Contrato verifier
- [x] CLI de prova
- [x] Testes Hardhat
- [x] Deploy Sepolia
...
| Camada | Tecnologias |
|--------|-------------|
| **Principal** | Circom, SnarkJS, Solidity, Hardhat |

## Arquitetura

```mermaid
flowchart LR
  ID[Identidade off-chain] --> CIR[Circuit Circom]
  CIR --> PRV[Prova Groth16]
  PRV --> VER[Verifier on-chain]
```
...
Node.js, circom/snarkjs toolchain.

## Instalação e execução

```bash
git clone https://github.com/SrSatriano/identity-vault-zk-proofs.git
cd identity-vault-zk-proofs
```
...
<p align="center">
  ...
  <a href="https://github.com/SrSatriano/identity-vault-zk-proofs">Este repositório</a>
</p>
